    ...
    courses: [
      {
        ...
        syllabus: [
          ...
          },
          {
            unit: 2,
            topics:
              "Data Types, Expressions, and Statements: Python interpreter and interactive mode, debugging; values and types: int, float, Boolean, string, and list; variables, expressions, statements, tuple assignment, precedence of operators, comments.",
          },
          {
            unit: 3,
            topics:
              "Control Flow Functions, and Strings: Conditions, iteration, fruitful functions, recursion; Strings - string slices, immutability, string functions and methods; Lists as arrays.",
          },
          {
            unit: 4,
            topics:
              "Lists, Tuples, Dictionaries: Lists, tuples, dictionaries, list comprehension.",
          },
          {
            unit: 5,
            topics:
              "Files, Modules, Packages: Files and exception handling, modules, packages.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        syllabus: [
          ...
          },
          {
            unit: 2,
            topics:
              "Differential calculus of functions of several variables, partial differentiation, homogeneous functions and Euler’s theorem, Taylor’s and Maclaurin’s series, Taylor’s theorem for functions of two variables, maxima and minima of functions of several variables, Lagrange’s method of multipliers.",
          },
          {
            unit: 3,
            topics:
              "Double and triple integrals, change of order of integration, change of variables, applications to evaluation of area, surface area and volume.",
          },
          {
            unit: 4,
            topics:
              "Scalar and vector fields; differentiation of vectors, velocity and acceleration, vector differential operators Del, Gradient, Divergence and Curl and their physical interpretations, formulae involving these operators, line, surface and volume integrals, solenoidal and irrotational vectors, Green’s theorem, Gauss divergence theorem, Stoke’s theorem and their applications.",
          },
          {
            unit: 5,
            topics:
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Quantum Theory: Concept of wave function and Born interpretation, normalization and orthogonality of wave functions; Schrödinger wave equations; operators, expectation values; time independent Schrödinger wave equation; particle in one dimensional infinite potential well.",
          },
          {
            unit: 2,
            topics:
          ...
          },
          {
            unit: 3,
            topics:
              "Crystal Structure and Defects: Crystalline and amorphous solids, Crystal systems, closed packed structures, Crystallographic planes and directions, Miller indices, Crystal defects and dislocations, X-Ray Diffraction (Bragg's law), types of bonding.",
          },
          {
            unit: 4,
            topics:
              "Semiconductor Physics: Distinction between metals, semiconductors & insulators; Intrinsic and extrinsic semiconductors; Drift velocity, mobility and conductivity of intrinsic semiconductors; Fermi level in intrinsic and extrinsic semiconductors; p-n junction diode.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "DC Circuits : Introduction, Active, Passive and Bilateral Elements, Electrical circuit elements (R, L and C), Ideal & Practical Voltage and Current Sources, Ohm’s Law, Kirchhoff’s laws, Mesh and Nodal Analysis, Star-Delta conversion, Superposition Theorem, Thevenin Theorem, Norton Theorem and Maximum Power Transfer Theorem.",
          },
          {
            unit: 2,
            topics:
              "AC Circuits: Introduction, Representation of sinusoidal waveforms, Peak, average and RMS values, Phasor representation, real power, reactive power, apparent power, power factor and form factor. Analysis of single-phase AC circuits consisting of R, L, C, RL, RC, RLC (series and parallel combinations) and resonance. Introduction to 3-phase Networks: Balanced Star-Delta connections, phase and line currents and voltages and their relations. Measurement of power in 3-phase circuits.",
          },
          {
            unit: 3,
            topics:
              "Magnetic Circuits & Transformers : Introduction, Analogy between electrical and magnetic circuits, Magnetic circuits, Mutual inductance, Coupling Coefficient, Analysis of Coupled Coils, Dot Rule. Basics of ideal and practical transformer, equivalent circuit, open circuit and close circuit test on single phase transformer, losses in transformers (hysteresis and eddy current losses), regulation and efficiency.",
          },
          {
            unit: 4,
            topics:
              "Electrical Machines: Introduction, Types of Electrical Machines and their applications. Construction, principle and working of DC motor and DC generator. Introduction to single-phase and three-phase Induction motor.",
          },
          {
            unit: 5,
            topics:
              "Electrical Installations, Testing and Safety : Introduction, different types of wiring, electrical installation, safety, testing and hazard control. Concepts of grounding and earthing.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Introduction: Basics components of a digital computer system, Basic operation of digital computers, basic concepts of integer and floating-point number representations, Different paradigms of computer programming language, Compiler, Interpreter, Assembler, Structure of C program, Compilation process.",
          },
          {
            unit: 2,
            topics:
              "Basics of C programming: Character sets, Identifiers, Keywords, Data Types, Constants, Enumeration Constants, variables, statements; Operators and Expressions: Arithmetic operator, Unary operator, Relational and Logical operator, Assignment operator, Bitwise operator, Ternary operator, Comma operator, precedence and associativity; Input/Output statements, Decision making statements: if – else, nested if-else, Switch statement; Looping statements, Pre-processor directives, Pointers, Pointer operators, Pointer arithmetic.",
          },
          {
            unit: 3,
            topics:
              "Arrays and Strings: Introduction to Arrays: Declaration, Initialization, one dimensional array, Example Program: Computing Mean, Median and Mode, Selection sort, linear and binary search; Two dimensional arrays, Array Address Calculations, String operations: length, compare, concatenate, copy; pointers and Strings, Array of pointers and Pointer to an array.",
          },
          {
            unit: 4,
            topics:
          ...
          },
          {
            unit: 5,
            topics:
              "Structures: Structure, Nested structures, Pointer and Structures, Array of structures, Example Program using structures and pointers, Self-referential structures, Dynamic memory allocation, Singly linked list, typedef",
          },
          {
            unit: 6,
            topics:
              "File Processing: Files, Types of file processing: Sequential access, Random access, Sequential access file, Example Program: Finding average of numbers stored in sequential access file, Random access file, Command Line arguments.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Communication: Meaning, Significance, Process, Verbal, Non-Verbal, Types, Formal, Informal channels, Functions, Barriers to communication, Miscommunication, Effective communication strategies, Ethical & legal communication, Role of communication in society.",
          },
          {
            unit: 2,
            topics:
              "Technology-enabled communication: Tools, Positive and negative impact of technology-enabled communication, Appropriate & effective technology-based communication.",
          },
          {
            unit: 3,
            topics:
              "Business Correspondence & Etiquettes: Elements of business writing, Business letters, Memorandum, Purchase order, Quotation and tenders, Job application letters, Resume writing, Press release, Etiquettes.",
          },
          {
            unit: 4,
            topics:
              "Phonetics: Organs of speech, Mechanism of sound production, Vowel and consonant sounds, Places of articulation, Manner of articulation, Stress, Intonation.",
          },
          {
            unit: 5,
            topics:
              "Basic Applied Grammar and Usage: Transformation of sentences, Words used as different parts of speech, One word substitution, Abbreviations, Technical terms, Foreign expressions, Sentences: kinds of sentences, Phrases. Parts of speech. Synonyms & antonyms, Spotting errors in sentences, Homophones, Homonyms.",
          },
          {
            unit: 6,
            topics:
              "Reading & Writing Skills: Process of reading, Reading purposes, Characteristic of efficient reading, Models, Strategies, Methodologies, Reading comprehension, Improving comprehension skills, Reading activities. Elements of effective writing, Writing styles, Scientific & technical writing.",
          },
          {
            unit: 7,
            topics:
              "Listening & Speaking Skills: Meaning, Process & types of listening, Active & passive listening, Barriers to listening, Effective listening skills, Feedback skills, Role of listening in an organization. Effective speaking and talk.",
          },
          {
            unit: 8,
            topics:
              "Meeting and Telephonic Skills: Conducting a meeting, Notice, Agenda, Minutes of the meeting, Note of dissent, Telephonic communication, Oral presentation and role of audio visual aids.",
          },
          {
            unit: 9,
            topics:
              "Report Writing: Process of research: Defining and narrowing down the problem, Statement of the problem, Literature review, Hypothesis, Research methodology, Collecting data, Interpreting data, Writing report, Kinds and purpose of Report, Objectives of report, Writing a routine business report, Elements of a long formal report: Abstract, Summary, Introduction, Methodology, Findings and analysis, Conclusion and recommendation, Glossary, Appendix, Index, Bibliography.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Review of semiconductors: Introduction, semiconductor materials, covalent bond, extrinsic and intrinsic materials, energy levels, p-type and n-type semiconductors.",
          },
          {
            unit: 2,
            topics:
              "Analog Electronics: Introduction, semiconductor diodes, ideal versus practical diodes, diode applications: rectifier circuits (half-wave and full-wave rectifiers, rectifiers with capacitor filter), clipper (limiter) and clamper circuits, introduction to BJT, structure and modes of operation, n-p-n and p-n-p transistor in active mode, introduction to op-amp, ideal op-amp, inverting and non-inverting configuration.",
          },
          {
            unit: 3,
            topics:
              "Digital Electronics: Introduction, Boolean algebra and rules of simplification; logic gates, combinational circuits like adder, decoder, encoder, multiplexer and de-multiplexer; brief introduction to sequential circuits like flip-flops, counters and shift registers.",
          },
          {
            unit: 4,
            topics:
          ...
          },
          {
            unit: 5,
            topics:
              "Basics of Instrumentation: Introduction to instrumentation and its functional elements, applications of instrument systems, classification of instruments, selection of instruments, Basic sensing elements: resistive elements, capacitive elements, inductive.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Humans and the Environment: Definition, scope and importance. Multidisciplinary Nature. Environmental Ethics and Emergence of Environmentalism: Anthropocentric and eco-centric perspectives (major thinkers).",
          },
          {
            unit: 2,
            topics:
      ...
      },
      {
        ...
        syllabus: [
          ...
          },
          {
            unit: 2,
            topics:
              "Linear differential equations with constant coefficients, Cauchy's homogeneous linear equation Legendre's linear equation, simultaneous linear equations with constant coefficients.",
          },
          {
            unit: 3,
            topics:
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Solid Mechanics: System of forces, coplanar concurrent force system, composition and resolution of force, equilibrium of rigid bodies, free body diagram, Lami’s theorem.",
          },
          {
            unit: 2,
            topics:
          ...
          },
          {
            unit: 4,
            topics:
              "Stress and strain: Concept of stress and strain, simple stresses, tensile, compressive, shear, bending and torsion, stress- strain curves, elongation of bars, composite bars, thermal stresses, elastic constants.",
          },
          {
            unit: 5,
            topics:
              "Thermal Science: Introduction and scope of thermodynamics, thermodynamics properties, forms of energy, thermodynamic systems and control volume, steady flow systems, types of work, thermodynamic processes, laws of thermodynamics, Carnot theorem, concept of entropy. Available energy, availability and irreversibility, Gas power cycles, refrigeration cycles, elements of heat transfer-conduction, convection and radiation.",
          },
          {
            unit: 6,
            topics:
              "Fluids: Fluid and their properties: Ideal and real fluids, capillarity, Vapour pressure, compressibility and bulk modulus, Newtonian and non-Newtonian fluids. Fluid Statics: Concept of pressure, Pascal’s law and its engineering applications, action of fluid pressure on a plane (horizontal, vertical and inclined) submerged surface, resultant force and centre of pressure, Buoyancy and flotation, stability of floating and submerged bodies, Metacentric height.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Network Analysis Techniques: Reciprocity Theorem, Milliman’s Theorem, Tellegen’s Theorem and Maximum Power Transfer Theorem – Applications of Network Theorems to network analysis both with AC and DC inputs and dependent and independent sources, Magnetic Coupling.",
          },
          {
            unit: 2,
            topics:
              "Applications of Laplace Transform: Introduction, some basic theorems, solutions of Linear Differential Equations for electric network-problems, partial fraction Expansion-Heaviside’s Expansion Theorem, The convolution Integral-evaluation; Application of Laplace Transform to analysis of electrical circuits – Linear time invariant first and second order circuits. Zero input response, Zero state response and complete response. Impulse response of first and second order circuits, time varying circuits.",
          },
          {
            unit: 3,
            topics:
              "Graph Theory and Network Equations: Introduction, graph of a network, trees, co-trees and loops, incidence matrix, Cut-set matrix, Tie-set matrix and loop currents, Analysis of networks using graph theory, duality, and general network transformations.",
          },
          {
            unit: 4,
            topics:
              "Network Functions: Ports and terminal pairs, network functions, Poles and zeros, necessary conditions for driving point functions and transfer functions, Time-domain analysis from pole zero plot.",
          },
          {
            unit: 5,
            topics:
              "Two Port Networks: Introduction, Characterization of linear time invariant two port networks, Z-, Y-, h- and transmission parameters, Interrelationship between these parameters, Interconnection of Two-port networks, Image parameters; Attenuation and phase shift in symmetrical T- and pi- networks.",
          },
          {
            unit: 6,
            topics:
              "Filters and Active Networks: Introduction to Fourier Transform, Classifications of filters, Filter networks, pass band and stop band types, Constant k-low pass and high pass filters, Characteristics impedance and cut off frequency, m-derived filters.",
          },
        ],
      },
      {
        ...
        syllabus: [
          ...
          },
          {
            unit: 4,
            topics:
              "Magnetic Measurement: Working principle and theory of Ballistic galvanometer, Measurement of flux density, determination of B-H curve, Hysteresis loop, Ewing double bar permeameter, Hopkinson permeameter, separation of iron losses by wattmeter and Bridge methods, Measurement of Leakage Factor with Flux meter.",
          },
          {
            unit: 5,
            topics:
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Characteristics of instruments and Measurement System: Measurement systems, basic block diagram of instrumentation system, classification of transducers, static and dynamic performance characteristics, compensation, loading effect, criteria for transducer selection, calibration.",
          },
          {
            unit: 2,
            topics:
          ...
          },
          {
            unit: 3,
            topics:
              "Temperature Measurement: Non-electrical methods for measurement of temperature-thermometers, bimetallic strip, Resistance Thermometer, RTD (3/4 wire) Thermistors, thermo-electric sensors-thermocouples, Radiation methods-pyrometers.",
          },
          {
            unit: 4,
            topics:
              "Miscellaneous Transducers: Optical transducers: photo-emissive, photo-conductive, and photo-voltaic cells, digital transducers: optical encoder, shaft encoder, hall-effect transducers, magneto-strictive transducer, electrochemical transducer, smart sensors.",
          },
          {
            unit: 5,
            topics:
              "Signal Conditioning: Basic concepts of signal conditioning, AC/DC Bridge applications, operational amplifiers: its application in instrumentation, Instrumentation amplifier, charge amplifier, filters, Interference, grounding, and shielding.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Roots of algebraic and transcendental equations: Bisection Method, Regula – Falsi method, Newton – Raphson method, Barstow’s method and Graffe’s root squaring method.",
          },
          {
            unit: 2,
            topics:
              "Solution of simultaneous algebraic equations: matrix inversion and Eigen-value problems, triangularisation method, Jacobi’s and Gauss-Seidel iteration method, partition method for matrix inversion, power method for largest eigen-values and Jacobi’s method for finding eigen-values.",
          },
          {
            unit: 3,
            topics:
              "Interpolation and Finite differences: Finite differences, interpolation and numerical differentiation, forward, backward and central differences, Newton’s forward, backward and divided difference interpolation formulas, Lagrange’s interpolation formula, Stirling’s and Bessel’s central difference interpolation formulas, numerical differentiation using Newton’s forward and backward difference formulas and Numerical differentiations using Stirling’s and Bessel’s central difference interpolation formulas.",
          },
          {
            unit: 4,
            topics:
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Magnetics and Energy Conversion: Magnetic circuit, Analogies between electric and magnetic circuits, Magnetic Hysteresis and Hysteresis loss, Interaction of magnetic fields, Motor action, Generator action, Eddy current and eddy current losses, Multi-polar machines.",
          },
          {
            unit: 2,
            topics:
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Introduction: Fundamentals of signal and systems, Basic Elements of a Digital Signal Processing System, Classification of Continuous and Discrete Systems: Static & Dynamic, Linear & Nonlinear, Time-variant & Time-invariant, Causal & Non-causal, Stable & Unstable, Recursive & Nonrecursive. Deterministic & Random signals, Energy & Power signals, Correlation, Auto Correlation, Cross Correlation, Analog systems, Correlation, Convolution, Energy density, Spectral Density, Properties of Correlation and Spectral density and their interrelations.",
          },
          {
            unit: 2,
            topics:
              "Fourier series and Fourier Transform: CTFS, CTFT, DTFS, DTFT and its properties, magnitude and phase representation, Computation of DTFT using FFT algorithm, Fast Fourier Transform – Decimation-in-frequency, Decimation-in-time, Butterfly structure, Signal Sampling and Quantization.",
          },
          {
            unit: 3,
            topics:
              "Discrete Time Signal Analysis: Z-transform and its properties, inverse Z-transform, difference equation, Block diagram representation of Discrete-Time Systems, Stability analysis, application to discrete systems, Analysis of Linear Time-Invariant Systems in the Z-Domain, Discrete Convolution.",
          },
          {
            unit: 4,
            topics:
              "Design of Digital Filters: FIR & IIR filter realization – Parallel & cascade forms, FIR design: Windowing techniques – Need and choice of windows – Linear phase characteristics, IIR design: Pole-zero placement, Impulse-invariant, matched z-transform and bilinear transformation methods.",
          },
          {
            unit: 5,
            topics:
              "Digital Signal Processors: Introduction – Architecture – Features – Addressing Formats – Functional models.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Introduction to Concepts: Plant, Systems, Servo mechanisms, regulating systems, disturbances, Open loop control system, closed loop control systems, linear and non-linear systems, time variant and invariant, continuous and sampled-data control systems, Block diagrams and modelling of systems.",
          },
          {
            unit: 2,
            topics:
              "Modeling: Formulation of equation of linear electrical, mechanical, thermal, pneumatic and hydraulic systems, Electrical mechanical analogies, Use of Laplace transforms, Transfer function, concept of state variable modelling.",
          },
          {
            unit: 3,
            topics:
              "Time Domain Analysis: Typical test input signals, Transient response of the first and second order systems, Time domain specifications, Dominant poles of higher order systems.",
          },
          {
            unit: 4,
            topics:
              "Root Locus Technique: The concept of root locus for open loop and closed loop systems, Rules for drawing root locus, Breakaway points, Intersection with imaginary axis, location of roots with given gain and effect of PID controllers.",
          },
          {
            unit: 5,
            topics:
              "Frequency Domain Analysis: Closed loop frequency response, Bode plots, stability and loop transfer function, Frequency response specifications, Relative stability, Routh-Hurwitz criterion, Nyquist criterion, Gain margin, Phase margin, Polar plot, Compensation: Necessity of compensation, series and shunt compensation, compensators.",
          },
          {
            unit: 6,
            topics:
              "Control Components: Error detectors – Potentiometers and Synchros, dc and ac servo motors, tachogenerators.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Introduction: Review of the functional block diagram of a sensor-based measurement system, generalized performance characteristics of sensors-based instrumentation, terminology and classification.",
          },
          {
            unit: 2,
            topics:
          ...
          },
          {
            unit: 3,
            topics:
              "Pressure Measurement: Introduction, classification of pressure sensor, units of pressure, manometers, elastic type pressure gauges (Bourdon tube, diaphragm, bellows), electrical pressure transducers for pressure measurement (strain gauges, capacitive type pressure transducer), measurement of vacuum.",
          },
          {
            unit: 4,
            topics:
              "Flow Measurement: Introduction, classification, basic principle, mass flow type, positive displacement type, construction details and theory of head flow meters (orifice plate, venture tube, pitot tube, rotameter), inferential flow meter, turbine flow meter, electromagnetic flow meter, vortex meter.",
          },
          {
            unit: 5,
            topics:
              "Other Variable Measurements: Level measurement (float type, differential pressure type, electrical capacitance type, ultrasonic level sensor), humidity measurement, solid level measurement, mass, weight, force, torque, and shaft power measurement, accelerometers, vibration displacement, velocity and acceleration measurement, vibration measurement.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Introduction: Introduction to computer architecture and organization, Von Neumann and Harvard architecture, RISC and CISC processors, 8-, 16-, 32- and 64-bit processors.",
          },
          {
            unit: 2,
            topics:
              "Introduction to 8-bit Microprocessor: Intel 8085 microprocessor, pin configuration, architecture, instruction format, types of instructions, instruction set, addressing modes, timing diagrams, programming 8085, stack, interrupts.",
          },
          {
            unit: 3,
            topics:
              "Peripherals and Interfacing for 8085: Memory interfacing, I/O interfacing: memory-mapped and peripheral-mapped I/O, data transfer schemes, overview of 8251, 8253/8254, 8255, 8279",
          },
          {
            unit: 4,
            topics:
              "Introduction to 16-bit Microprocessor: Architecture of Intel 8086, block diagram, register set, flags, Queuing, concept of segmentation, Pin description, operating modes, addressing modes and interrupts.",
          },
          {
            unit: 5,
            topics:
              "Microcontrollers: Introduction, factors to be considered for selection of a microcontroller, Intel 8051 microcontroller, architecture, pin configuration, addressing modes, classification of instructions, instruction set, programming 8051, Timer/Counter programming; Serial communication and programming; programming of Interrupts and priority of interrupts, Interfacing with LCD, 7-segment display, ADC/DAC.",
          },
          {
            unit: 6,
            topics:
              "Embedded Systems: Introduction, comparison with a general computing system; Classification of embedded systems; Challenges with embedded systems; Application areas and purpose of embedded systems; Characteristics and quality attributes of embedded systems, Elements of a typical embedded system, introduction to hardware-software co-design.",
          },
          {
            unit: 7,
            topics:
              "Open Source Electronics Platform: Introduction, introduction to Arduino, Arduino IDE, Arduino libraries, creating an Arduino program, Arduino applications, introduction to Raspberry Pi.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "State Space Analysis of Continuous System: State variable representation of continuous system, conversion of state variable models to transfer function and vice-versa, solution of state equations and state transition matrix",
          },
          {
            unit: 2,
            topics:
              "State Feedback Control and Observer Design: Similarity transformation, Controllability and observability (Gilbert's, Kalman, factor cancellation and PBH tests), pole placement design, state feedback control design, full and reduced order state observer design",
          },
          {
            unit: 3,
            topics:
              "Fundamentals of Nonlinear System: Types of non linarites, phenomena related to non-linear systems. Analysis of nonlinear systems-Linearization method, second order non-linear system on the phase plane, types of phase portraits, singular points, system analysis by phase-plane method, describing function and its application to system analysis.",
          },
          {
            unit: 4,
            topics:
              "Stability: BIBO and asymptotic stability, sign definiteness, quadratic forms, Sylvester's criterion for sign definiteness, Lyapunov's stability theorems for continuous systems (first and second method), Popov's criterion.",
          },
          {
            unit: 5,
            topics:
              "Optimal Control: Introduction, formation of optimal control problem, calculus of variations minimization of functions, constrained optimization. Pontryagin's Minimum Maximum Principle, Linear Quadratic Problem-Hamilton Jacobi equation, Riccati equation and its solution.",
          },
        ],
      },
      {
        ...
        syllabus: [
          {
            unit: 1,
            topics:
              "Introduction: Elements of analytical Instrument, Performance requirements of analytical instruments such as errors in chemical analysis, Accuracy and precision, SNR. Intelligent analytical Instrumentation system, PC-Based Analytical Instruments, MEMS in Analytical Instruments, Micro-Fluidics in Analytical Instruments.",
          },
          {
            unit: 2,
            topics:
              "Chromatographic Techniques: Gas Chromatography (GC), Gas Chromatography mass-spectroscopy (GC-MS) Liquid Chromatography (LC), High-Performance Liquid Chromatography (HPLC), Liquid Chromatograph-Mass Spectrometer (LC/MS), Ion Chromatography (IC)- principles, components and applications.",
          },
          {
            unit: 3,
            topics:
              "Gas Analysis: Thermal conductivity gas analyzers, Heat of reaction method, Estimation of Oxygen, Hydrogen, Methane, CO2, Carbon monoxide etc. in binary or complex gas mixtures, paramagnetic oxygen analyzer, Electro chemical reaction method, Polarography, Density measurement.",
          },
          {
            unit: 4,
            topics:
              "Chemical Composition Measurements: Measurement of pH: - definition and methods, redox potential, electrical conductivity, conductivity cell and applications, density measurement: solids, liquids, gases.",
          },
          {
            unit: 5,
            topics:
              "Optical Measurements: Principles of optical measurements (refraction, reflection, transmission, scattering), Optical components (lenses, mirrors, gratings, different optical filters, monochromators, photosensitive detectors), Optical alignment techniques, Light sources (LED, LASER), basics of fibre optics.",
          },
          {
            unit: 6,
            topics:
              "Colorimeters and Spectrophotometers: EM spectrum, interaction of radiation with matter, Laws related to absorption of radiation: Beer-Lambert's law, Spectrophotometry: UV, IR, Photoacoustic, NMR, Mass, Atomic absorption, Flame photometers. Colorimeters: single beam filter photometer and double Beam colorimeter.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        syllabus: [
          ...
          },
          {
            unit: 2,
            topics:
              "Concerns of Measurement: Measurements in manufacturing, Measurement in the global marketplace, Importance of measurement, study of various errors in instruments, Need for better measurements, Determine and describe the differences between resolution, accuracy, precision, calibration, Type A uncertainty and Type B uncertainty.",
          },
          {
            unit: 3,
            topics:
              "Standards: Study of Various Indian Standards codes for various important electrical equipment’s, Working standards, check standards and international standards, Definition of metrology, Requirements of traceability, Metrology standardization documents.",
          },
          {
            unit: 4,
            topics:
              "Installation & Commissioning: overview of site management and activities, safety management, power quality, testing of plant and equipment, domestic installation and home appliances, information technology applications in electrical plants, Installing and commissioning engineering equipment’s, Energy and power plants, distribution systems.",
          },
          {
            unit: 5,
            topics:
              "Testing and Maintenance Strategies: site testing and checking, care, servicing and maintenance of motors, maintenance management of rotating machines and EPMP, testing of new & old electrical installation as per IS, Electrical Maintenance and Testing Strategies, Planning an EPM Program, Types of Tests, Types of testing Methods, Protective Relays and Instrument Transformers.",
          },
          {
            unit: 6,
            topics:
              "Calibration: basics and different Terminologies, Calibration requirements, metrology and calibration services, calibration activities, calibration Record keeping, documented procedures, calibration of equipment’s as per IS specification.",
          },
        ],
      },
      {
