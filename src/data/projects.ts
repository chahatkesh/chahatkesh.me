...
const projects: Project[] = [
  {
    ...
    timelineDescription:
      "Built and iterated on my personal portfolio as a full-stack Next.js 15 product, adding an interactive timeline, admin-controlled CMS, live analytics, and SEO systems to showcase projects, writing, and growth.",
    features: [
  ...
  },
  {
    ...
    timelineDescription:
      "Built Swasya AI for Indian PHCs with a hybrid AWS serverless architecture, live speech-to-SOAP workflows, and coordinated nurse-doctor experiences across web and mobile to reduce diagnosis friction in real clinical operations.",
    features: [
  ...
  },
  {
    ...
    timelineDescription:
      "Designed and shipped GW Infra Solutions, a production-ready platform for a solar company with CMS workflows, admin analytics, secure JWT auth, and scalable Node.js plus React architecture for daily content and operations.",
    features: [
  ...
  },
  {
    ...
    timelineDescription:
      "Built OpenLearn, a full-stack cohort learning platform with role-based access, gamified progression, real-time dashboards, and a robust TypeScript backend powering structured tracks and community-led growth.",
    features: [
  ...
  },
  {
    ...
    timelineDescription:
      "Developed Tomato, a full-stack food delivery ecosystem with customer and admin apps, secure Stripe payments, and real-time order workflows spanning menu discovery, checkout, and fulfillment.",
    features: [
  ...
  },
  {
    ...
    timelineDescription:
      "Engineered Blogger, a Next.js-powered publishing platform with admin CMS workflows, Cloudinary media handling, subscription management, and SEO-first architecture for fast, discoverable content delivery.",
    features: [
  ...
  },
  {
    ...
    timelineDescription:
      "Built GitRoast, an AI app that analyzes GitHub profiles and generates technically accurate, shareable roasts with configurable tone, blending developer humor with strong API and product engineering.",
    features: [
