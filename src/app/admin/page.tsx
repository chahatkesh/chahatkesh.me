      ...
      <div className="flex items-center justify-center min-h-[80vh] px-4">
        ...
        >
          <div className="mb-8 text-center space-y-2">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-neutral-800 to-neutral-900 mb-4 border border-neutral-800">
              <svg
