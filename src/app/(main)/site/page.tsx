  ...
  return (
    <div className="space-y-8">
      ...
      <PageHeader
        ...
        subtitle="Stack, patterns, and the trade-offs behind this site."
      />
        ...
        <section>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
            {[
              {
                icon: FiGitCommit,
                value: commitCount > 0 ? commitCount.toLocaleString() : "100+",
                label: "Commits",
              },
              {
                icon: FiCode,
                ...
                <div className="space-y-12">
                  ...
                  <RevealSection className="space-y-6">
                    ...
                    <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
                      ...
                      Presentation → State → Data → Infrastructure. No circular
                      imports, no spaghetti.
                    </p>
                ...
                <div className="space-y-12">
                  ...
                  <RevealSection className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
                        Optimizations that keep this portfolio fast, efficient,
                        and delightful to use — from server-side rendering to
