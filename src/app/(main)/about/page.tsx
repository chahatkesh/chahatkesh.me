  ...
  return (
    <div className="space-y-8">
      ...
      <PageHeader
        ...
        title="Chahat, 20"
        subtitle="I build products, ship often, and care about the craft."
      />
            ...
            <div className="grid gap-6 sm:gap-6 md:grid-cols-3 md:items-stretch">
              <div className="order-2 space-y-4 sm:order-1 md:col-span-2">
                <p className={typo({ variant: "paragraph", font: "sans" })}>
                  ...
                  Websites, tools, startups that didn&apos;t work, startups that
                  did. Every project taught me something a textbook
                  couldn&apos;t.
                </p>

                <p className={typo({ variant: "paragraph", font: "sans" })}>
                  Late-night side projects, AI research at IIT Ropar, hackathon
                  wins, a founding engineer role at a Singapore-based startup,
                  and now co-founding Layr. Each step has been less about the
                  destination and more about how much I could learn before the
                  next one.
                </p>

                <p className={typo({ variant: "paragraph", font: "sans" })}>
                  What excites me isn&apos;t just the technology. It&apos;s the
                  architecture. How systems fit together. How fast a focused
                  team can ship without breaking things. How good design and
                  good engineering are actually the same discipline.
                </p>
            ...
            <div className="relative mt-6 overflow-hidden rounded-xl border border-border bg-card/30 px-7 py-9 sm:px-9 sm:py-10">
              ...
              <div className="relative z-10 space-y-5 pl-2 font-poem text-[0.98rem] italic leading-[1.85] text-muted-foreground sm:text-[1.03rem]">
                ...
                <p className="not-italic text-foreground/90">
                  ...
                  <br />
                  who loves as <em className="italic text-ring">fiercely</em> as
                  I build.
                </p>
              </div>
            </div>
