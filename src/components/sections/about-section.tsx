    ...
    <section className="grid gap-8 sm:gap-4 md:grid-cols-3" aria-label="About">
      <div className="order-2 space-y-3 sm:order-1 md:col-span-2">
        ...
        <p className={typo({ variant: "paragraph", font: "sans" })}>
          ...
          Hello! I'm a developer from India passionate about programming and
          technology, with multiple wins across hackathons and ideathons.
        </p>
        ...
        <p className={typo({ variant: "paragraph", font: "sans" })}>
          ...
          I've delivered 15+ freelance projects, interned at two startups, and
          explored building my own startups in the past. I actively share my{" "}
          <a
            target="_blank"
        ...
        >
          I'm <span className="text-white">open to work</span>, freelance, or
          collaborate.{" "}
          <a
